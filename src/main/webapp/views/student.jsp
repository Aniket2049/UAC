...
<body>
<div class = "container">
  <h2 class = "text-center">Welcome to UAC Students Portal</h2>
  <hr>
  <div class = "row">
    ...
    <br>
    <br>
    <div class = "rankNotif">Since no real exam was held you have been randomly assigned exam rank of <b>${rank}</b> for
      ...
      <core:forEach items = "${pList}" var = "pItem">
        <tr class = "infoTR">
          ...
          <td class = "infoTD">
            ...
            <a href = "${delItem}"
               onclick = "if (!(confirm('Are you sure you want to delete this item from list?'))) return false">Delete</a>
          </td>
        </tr>
      </core:forEach>
    </table>
    ...
    <div class = "centerText">
      ...
      <a href = "${submitLink}"
         class = "bigButton"
         onclick = "if (!(confirm('Are you sure you want to send this preference list for admission?'))) return false">SUBMIT
                                                                                                                       for
                                                                                                                       Admission!</a>
    </div>
